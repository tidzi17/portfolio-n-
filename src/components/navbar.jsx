...
export default function Navbar(){
    ...
    return(
        <div id="navbar" className="absolute">
            <nav style={{ borderBottom: '1px solid ' + border, backgroundColor: bgColor }} className="w-full fixed z-20 flex justify-between px-6 items-center py-6 lg:pb-3 lg:pt-5 lg:px-28">
            <div>
